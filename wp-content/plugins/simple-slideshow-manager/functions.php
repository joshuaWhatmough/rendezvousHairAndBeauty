...
<div id="image_slideshow_holder" style='<?php if($acx_slideshow_width!="") { ?> max-width:<?php echo $acx_slideshow_width; ?>; <?php }?>'>
	...
	for($i = 0 ; $i<$slide_count; $i++)
	{
		if($acx_slideshow_imageupload_complete_data[$gallery_name][$i]['type']=="image") 
		{
			...
			?>
			<img src="<?php echo esc_url($acx_slideshow_imageupload_complete_data[$gallery_name][$i]['image_url']); ?>" title="<?php echo  $acx_slideshow_imageupload_complete_data[$gallery_name][$i]['image_title']; ?>" alt="<?php $acx_slideshow_imageupload_complete_data[$gallery_name][$i]['image_alttext']; ?>" style="<?php if ($acx_slideshow_height != ""){ ?>max-height:<?php echo $acx_slideshow_height;?>; <?php } ?><?php if ($acx_slideshow_width != ""){ ?> width:<?php echo $acx_slideshow_width;?>; <?php } ?>">
			<?php
			if($acx_slideshow_link_url!="")
			{
				?>
		...
		{	
			...
			<img class="acx_ssm_yt_<?php echo $uid; ?>_<?php echo $i; ?>" id="acx_image_<?php echo $uid; ?>_<?php echo $i; ?>" src="<?php echo esc_url($acx_slideshow_imageupload_complete_data[$gallery_name][$i]['thumbnail_image']); ?>" style="<?php if ($acx_slideshow_height != ""){ ?> max-height:<?php echo $acx_slideshow_height;?>; <?php } ?><?php if ($acx_slideshow_width != ""){ ?> width:<?php echo $acx_slideshow_width;?>; <?php } ?>" />
		...
		else if($acx_slideshow_imageupload_complete_data[$gallery_name][$i]['type']=="vimeo_video")
		{
			...
			<img class="acx_ssm_vm_<?php echo $uid; ?>_<?php echo $i; ?>" id="acx_image_vimeo_<?php echo $uid; ?>_<?php echo $i; ?>" src="<?php echo esc_url($acx_slideshow_imageupload_complete_data[$gallery_name][$i]['thumbnail_image']); ?>" style="<?php if ($acx_slideshow_height != ""){ ?>max-height:<?php echo $acx_slideshow_height;?>; <?php } ?><?php if ($acx_slideshow_width != ""){ ?> width:<?php echo $acx_slideshow_width;?>; <?php } ?>"/>
...
// Set some widget options
		...
		parent::__construct('acx_slideshow_widget','Simple Slideshow Manager', $widget_options ,$control_options );
    }
...
function acx_slideshow_ajax_upload_callback()
{
	...
	if(!isset($_POST['acx_slideshow_ajax_upload_es'])) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
	if(!wp_verify_nonce($_POST['acx_slideshow_ajax_upload_es'],'acx_slideshow_ajax_upload_es')) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
...
/* response display */
	...
	for($i = 0  ; $i <$slide_count ; $i++)
	{
		...
		else  if($acx_slideshow_imageupload_complete_data[$gallery_name][$i]['type']=="youtube_video")
		{
				...
				echo "<div class=\"del_but\" id=\"acx_delete_image_".esc_url($acx_slideshow_imageupload_complete_data[$gallery_name][$i]['video_url'])."\" onclick = \"acx_delete(".$i.");\" title=\"Delete This Slide\"></div></br>";	
				echo "</li>";
		}
		else  if($acx_slideshow_imageupload_complete_data[$gallery_name][$i]['type']=="vimeo_video")
		{
...
function acx_slideshow_ajax_updateRecordsListings_callback()
{
	...
	if(!isset($_POST['acx_slideshow_ajax_updateRecordsListings_es'])) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
	if(!wp_verify_nonce($_POST['acx_slideshow_ajax_updateRecordsListings_es'],'acx_slideshow_ajax_updateRecordsListings_es')) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
...
{
	global $wpdb,$acx_slideshow_misc_user_level;
	if(!isset($_POST['acx_slideshow_ajax_deleteimage_es'])) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
	if(!wp_verify_nonce($_POST['acx_slideshow_ajax_deleteimage_es'],'acx_slideshow_ajax_deleteimage_es')) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
...
$status='0';
global $wpdb;
	if(!isset($_POST['acx_ajax_renamefunction_es'])) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
	if(!wp_verify_nonce($_POST['acx_ajax_renamefunction_es'],'acx_ajax_renamefunction_es')) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
...
{
	global $wpdb;
	if(!isset($_POST['acx_slideshow_ajax_editimage_es'])) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
	if(!wp_verify_nonce($_POST['acx_slideshow_ajax_editimage_es'],'acx_slideshow_ajax_editimage_es')) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
...
{
	global $wpdb,$acx_slideshow_misc_user_level;
	if(!isset($_POST['acx_slideshow_ajax_changeedittext_es'])) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
	if(!wp_verify_nonce($_POST['acx_slideshow_ajax_changeedittext_es'],'acx_slideshow_ajax_changeedittext_es')) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
...
$acx_tweet_text = $acx_tweet_text_array[$acx_tweet_text];
	...
	<p>
	<a href="http://wordpress.org/support/view/plugin-reviews/simple-slideshow-manager" class="button" style="color:black;text-decoration:none;padding:5px;margin-right:4px;" target="_blank">Rate it 5 Stars on wordpress</a>
...
if($acx_slideshow_version < "2.1.1") // << Old Version // Current Verison
{
