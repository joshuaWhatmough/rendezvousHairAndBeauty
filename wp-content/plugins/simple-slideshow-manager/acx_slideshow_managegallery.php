...
/*get the form data, validate it and update database with new value starts*/
	if (!isset($_POST['acx_slideshow_save_config'])) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
	if (!wp_verify_nonce($_POST['acx_slideshow_save_config'],'acx_slideshow_save_config')) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
...
?>	
		...
		<div class="widefat" style="padding:8px;width:99%;margin-top:8px;" >
			...
			<input name="acx_slideshow_save_config" type="hidden" value="<?php echo wp_create_nonce('acx_slideshow_save_config'); ?>" />
