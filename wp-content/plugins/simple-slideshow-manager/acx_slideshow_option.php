...
/* Form data sent starts */
	...
	{	
		if (!isset($_POST['acx_slideshow_add_gall_config'])) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
		if (!wp_verify_nonce($_POST['acx_slideshow_add_gall_config'],'acx_slideshow_add_gall_config')) die("<br><br>Unknown Error Occurred, Try Again... <a href=''>Click Here</a>");
...
/* Normal page display starts */
	else
	{
		...
		if($acx_slideshow_version < '2.1.1') // Current Version
		{
			$acx_slideshow_version = '2.1.1'; // Current Version
...
<form name="acurax_si_form" method="post" onSubmit="javascript:return acx_validate_newgallery()">
		...
		<p class="widefat" style="padding:8px;width:99%;margin-top:8px;">	<?php _e('New Gallery Name','simple-slideshow-manager' ); ?>
			...
			<input name="acx_slideshow_add_gall_config" type="hidden" value="<?php echo wp_create_nonce('acx_slideshow_add_gall_config'); ?>" />
